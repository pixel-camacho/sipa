...
var v = new Vue({
    ...
    methods: {
       ...
       allVendedores() {
            ...
            axios.get("http://190.9.53.22:8484/apiSIPA/vendedor/allVendedores")
                    .then(response => (this.vendedores = response.data));

        },
         allMediosConocimientos() {

            axios.get("http://190.9.53.22:8484/apiSIPA/medioconocimiento/allMedioConocimiento")
          ...
          this.idproducto=event.target.value;
             axios.get("http://190.9.53.22:8484/apiSIPA/asesor/allAsesores")
       ...
       axios.post("http://190.9.53.22:8484/apiSIPA/solicitud/registrarSolicitud", data).then(function (response) {
